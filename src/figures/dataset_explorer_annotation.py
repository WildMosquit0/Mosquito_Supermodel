...
class AnnotationAnalyzer:
    ...
    def extract_metadata(self, batch_size: int = 200) -> None:
        ...
        for batch in tqdm(batches, total=total_batches, desc="Processing Image Batches"):
            for image_name in batch:
                metadata = self._process_single_image(image_name)
                if metadata:
            ...
            with open(annotation_path, "r") as file:
                ...
                for line in lines:
                    ...
                    if line:
                        ...
                        area = box_width * box_height/(img_width * img_height)
                        annotations.append({
                            "class": cls,
    ...
    def save_scatter_plots(self) -> None:
        ...
        plt.figure()
        # Create a box plot grouping by Num_Objects and showing distribution of Image_Area
        ...
        # Identify image(s) with maximum number of objects
...
if __name__ == "__main__":
    ...
    images_folder =      "/home/bohbot/workspace/datasets/mos/all_mos_new/images/train"
    annotations_folder = "/home/bohbot/workspace/datasets/mos/all_mos_new/labels/train"
    output_folder = "./output_annotation_analysis"

    analyzer = AnnotationAnalyzer(images_folder, annotations_folder, output_folder)
    analyzer.extract_metadata()
    
    # Save distributions for selected features
    features_to_plot = [
